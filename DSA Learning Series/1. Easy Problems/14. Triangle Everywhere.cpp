/*  Link :   https://www.codechef.com/CCSTART2/problems/EXTRICHK
    ...
    You're given the length of three sides a, b, and c respectively. Now If these three sides can form an Equilateral Triangle then print 1, if these three sides 
